...
if ( ! function_exists('youtube_embed'))
{
	...
	$old_embed = FALSE, $hd = FALSE, $https = FALSE, $suggested = FALSE)
	{
		...
		else
		{
			...
			$embed .= '" allowfullscreen title="'.$ytarr['title'].'"><noframes>Desculpe, infelizmente o este vídeo só pode ser visualizado por navegadores com suporte a esses recursos.</noframes></iframe>';
		}
		return $embed;
	}
}
